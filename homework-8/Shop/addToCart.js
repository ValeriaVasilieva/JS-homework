/* 
Скрипт подключен к странице products.html
При клике на корзину происходит переход на страницу checkout.html, поэтому посмотреть что в корзине 
доступно только при hover, мышь можно спустить вниз в выпадающее окно
*/
